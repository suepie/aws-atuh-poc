.PHONY: help \
	...
	app-env app-kc-env \
	app-dev app-kc-dev app-kc2-dev \
...
app-env: ## [app] app/.env を terraform output から自動生成（Cognito版）
	@cd $(TF_INFRA_DIR) && \
...
app-kc2-dev: ## [app] Keycloak-2版 SPA 開発サーバー起動 (port 5175)
	cd $(APP_KEYCLOAK_2) && npm run dev
