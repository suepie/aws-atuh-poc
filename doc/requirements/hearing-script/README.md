...
| [02-idp-federation.md](02-idp-federation.md) | **マスター表 B**（事業者・顧客 IdP 統合表、IdP 接続種別）| **B-200**（旧 A-13 + 旧 A-6 / B-201〜B-207 + 旧マスター表 A 統合）、B-208、B-609、B-615〜B-617 |
...
| **§3 既存接続元・アプリの現状把握** | **01-auth-flow.md（マスター表 C）+ 02-idp-federation.md（マスター表 B 事業者・顧客 IdP 統合表）** + 00-common.md + 04 + 06 + 07 + 10 |
...
2. **§3.1〜§3.2 の 2 大マスター表**（B-200 事業者・顧客 IdP 統合表 / B-100 アプリ）: 「IdP × アプリ」のマトリクス完結で Cognito vs Keycloak が事実上確定
