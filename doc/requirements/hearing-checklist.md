...
| **B-DR-1** | `[C]` | 🔴 | **RTO/RPO の顧客要件**（2026-07-23 追加、§NFR-5 の DR ヒアリング項目を転記、U8 O-U8-8 連動）| NFR-DR-001/002 | §NFR-5, [U8 §8.2.1/§8.9.1](../basic-design/08-availability-dr-design.md) | 顧客としての RTO/RPO 要件は?（本基盤推奨デフォルト = **Tier 2: RTO 1h / RPO 1min**。Tier 1（RTO 30 分）は Phase 1 では提供しない — Phase 2 検討、U8 §8.4.4）| Tier 2 受諾 / Tier 1 要求（規制根拠付き）/ Tier 3 で可 | | ⏳ |
