...
→ **本基盤への意味**: 本人からの開示・訂正・利用停止請求に「**遅滞なく**」応答する SOP 必須。Keycloak Admin API + Account Console + 運用フローで対応。
...
| **法 33** | 開示請求 | ✅ Keycloak Admin API + Account Console で対応可 | 運用 SOP 文書化 | Low |
| **法 34** | 訂正等 | ✅ 同上 | 同上 | Low |
