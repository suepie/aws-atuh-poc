...
| [01-exposure-boundary.md](01-exposure-boundary.md) | §FR-API-1 公開範囲（信頼プロファイル）（5 項目） | B-101〜B-106 |
...
3. **Phase B-1〜5**（技術要件）→ 公開範囲（信頼プロファイル） / 認証 / 流量 / Serverless / Container 等、機能標準の中核
...
- 全 135 項目の網羅版です。プロジェクト初期に **🔥 最優先 25 項目を Stage 1 として先行確認** することで、本標準の中核判断（公開範囲（信頼プロファイル）判定 / Serverless-Container 選定方針 / 監査アカウント役割 / ガードレール範囲）を早期確定できます。
