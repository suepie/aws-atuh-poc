...
- 2026-08-06: §10.2.1 Ingress に **REQ-IN-12（api. inbound の NFW 通過要否）注記**（Q1(a)。NFW 必須なら ALB→Lambda ターゲットへ載せ替え = Option 2）。
