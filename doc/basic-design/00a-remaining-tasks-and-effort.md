...
| **H. 設計成果物の執筆** 🆕 | **設計項目（機能/画面/データ/IF/バッチ/権限）の網羅と資料作成**。**v2 まで工数ゼロ計上だった最大の漏れ**。v2.3 で **148 項目**（汎用体系の漏れ 17 + **案件固有〔ADR 68 本〕突合で H-J プロダクト固有設計・H-K 契約/顧客提供 32 項目**） | — | **424** | +87 | 一部 顧客レビュー |
| **ベース合計(期待経路)** | | **108** | **585** | | **総計 693 人日** |
...
- 運用: 分岐が顕在化したら該当 C-* をベースに繰入れ、§1 サマリを更新する。**予算計画上は「693 + リスク引当 152 = 845 人日を上限」**と読む。
