...
| **A-20** 🆕 | **管理用の口からパスワードのハッシュが読めないことの実機確認** | ネットワーク分離を維持する根拠が「**管理用の口はハッシュを返さない**」という前提に立っているため、実機で確かめる。**崩れると分離の意味づけが変わる**（[脅威分析](research/network-separation-threat-analysis-2026-09-02.md)）| 0.5 | A-2.1 |
