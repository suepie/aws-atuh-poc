...
| **H. 設計成果物の執筆** 🆕 | **設計項目（機能/画面/データ/IF/バッチ/権限）の網羅と資料作成**。**v2 まで工数ゼロ計上だった最大の漏れ**。v2.4 で **201 項目**（+ **H-L 認証実装ガイド 10 部 50 章 108 人日**＝旧 HK-03 の 5 人日 1 行を全面展開） | — | **527** | +87 | 一部 顧客レビュー |
| **ベース合計(期待経路)** | | **108** | **688** | | **総計 796 人日** |
...
- 運用: 分岐が顕在化したら該当 C-* をベースに繰入れ、§1 サマリを更新する。**予算計画上は「796 + リスク引当 152 = 948 人日を上限」**と読む。
