...
| B-4.2 | 災害時の入口切替に関する合意資料 | DR 方式再判断(D-18.2)結果を反映した合意資料 | 2 | **D-18.2** |
...
| G-1.8 | 手順書: 災害時の切替判断 | 判断基準・ITDR フラグ(K-4) | 1 |
| G-1.9 | 手順書: 切替先での再構築 | ROSA 再構築+IaC 適用(D-18 決定方式で書く) | 2.5 |
| G-1.10 | 手順書: データの復元 | PITR/イミュータブル SS リストア(論理破壊系) | 2 |
| G-1.11 | 手順書: 元の地域への復帰 | 東京復帰・整合確認 | 1 |
