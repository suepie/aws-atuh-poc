...
const clientId = import.meta.env.VITE_KEYCLOAK_CLIENT_ID || 'auth-poc-spa-2';
const redirectUri = import.meta.env.VITE_REDIRECT_URI || 'http://localhost:5175/callback';
const postLogoutUri = import.meta.env.VITE_POST_LOGOUT_URI || 'http://localhost:5175/';
