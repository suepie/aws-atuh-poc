...
複数の顧客企業 + 複数バックエンドシステムをカバーする **AWS 上の共有認証基盤** プロジェクト。
現状フェーズ: PoC（Phase 1〜9）完了 → 要件定義フェーズ。

## はじめての方

→ **[ONBOARDING.md](ONBOARDING.md)** を読んでください（プロジェクト概要 + ドキュメントの読み順を案内しています）。

ドキュメント全体: [doc/00-index.md](doc/00-index.md)
